...
var currentMarker;
var userMarkers = [];
var markertype = 'castle';
var countmarker = {};
var mgroup = [
    'castle','tower','sidequest','altarofmemories','signpost','historicsite','occupiedsite','bounties',
    'banditcamp','enemyhideout','gerociousbeast','echoesofthepast','godhaven','lostletter','citymysteries'
...
L.tileLayer('media/kingsroad/{z}/{x}/{y}.png', {
    ...
    noWrap: true,
    errorTileUrl : 'media/kingsroad/empty.png'
}).addTo(map);
